...
df = pd.read_csv("E:/Users/System/Downloads/New-York-Stock-Price-Prediction-main/datasets/prices-split-adjusted.csv")
df.info()
df.head()
...
plt.plot(df[df.symbol == symbol].date_time, df[df.symbol == symbol].open.values, color='red', label='open')
plt.plot(df[df.symbol == symbol].date_time, df[df.symbol == symbol].close.values, color='green', label='close')
plt.plot(df[df.symbol == symbol].date_time, df[df.symbol == symbol].low.values, color='blue', label='low')
plt.plot(df[df.symbol == symbol].date_time, df[df.symbol == symbol].high.values, color='black', label='high')
...
plt.figure(figsize=(22, 8));
plt.plot(df[df.symbol == symbol].date_time, df_stock_norm.open.values, color='red', label='open')
plt.plot(df[df.symbol == symbol].date_time, df_stock_norm.close.values, color='green', label='low')
plt.plot(df[df.symbol == symbol].date_time, df_stock_norm.low.values, color='blue', label='low')
plt.plot(df[df.symbol == symbol].date_time, df_stock_norm.high.values, color='black', label='high')
